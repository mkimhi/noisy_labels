    ...
    def build_hooks(self):
        ...
        if comm.is_main_process():
            ret.append(hooks.PeriodicCheckpointer(self.checkpointer, cfg.SOLVER.CHECKPOINT_PERIOD,
                                                  max_to_keep=cfg.SOLVER.MAX_CP_TO_KEEP))
...
"""
    ...
    @classmethod
    def test(cls, cfg, model, evaluators=None, rnd_mode=False, inference_folder=None):
        """
        ...
        for idx, dataset_name in enumerate(cfg.DATASETS.TEST):
            ...
            if evaluators is not None:
                ...
                try:
                    evaluator = cls.build_evaluator(cfg, dataset_name, output_folder=inference_folder)
                    ...
                    continue
            results_i = inference_on_dataset(model, data_loader, evaluator, rnd_mode=rnd_mode)
